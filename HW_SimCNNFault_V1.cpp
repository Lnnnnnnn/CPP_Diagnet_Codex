...
// 1. BatchNorm layers are not included because trained statistics/affine parameters are not available.
//    Fold BN parameters into the weight arrays before synthesis if they are required.
